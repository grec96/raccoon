...
if($error=="no")
{
		...
		$connection =  mysql_connect("localhost", "grec", "123");
		$db = mysql_select_db("grec");
...
$to = "zelic96@gmail.com";//Ваш e-mail адрес
...
mail($to, $sub, $mes, $headers);
      mysql_query("INSERT INTO info (name, email, message, date1, time1)
